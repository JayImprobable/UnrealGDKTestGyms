...
* Validation:
  1. At 10 seconds all cubes are deleted and success message is shown.
  2. Clients connecting after this point cannot see any cubes and, when pressing the `F` keyboard button, see a success messages on screen.
